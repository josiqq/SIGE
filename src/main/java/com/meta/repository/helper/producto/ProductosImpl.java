...
import com.meta.dto.InventarioMapper;
import com.meta.dto.ProductoCotizadoDTO;
import com.meta.dto.ProductoCotizadoDTOMapper;
import com.meta.dto.ProductoDTO;
import com.meta.dto.ProductoMobileDTO;
import com.meta.dto.ProductoMobileMapper;
import com.meta.dto.ProductoStockDTO;
import com.meta.dto.ProductoStockDTOMapper;
import com.meta.dto.StockValorizadoDTO;
import com.meta.dto.StockValorizadoMapper;
...
public class ProductosImpl implements ProductosQueries {
   ...
   public List<ProductoDTO> buscarTodo(String nombreCodigo) {
      String jpql = "SELECT DISTINCT NEW com.meta.dto.ProductoDTO(p.id, p.nombre, p.codigo, p.pesable, p.foto, p.costo, p.marca) FROM Producto p LEFT JOIN p.items i WHERE (p.nombre LIKE :nombre OR p.codigo = :codigo OR i.codigoAlternativo = :codigo) AND p.activo = true";
      return this.manager
